...
contract('', async ([owner]) => {
  ...
  it('[90000880] mint Cfnc for exchange,should success ', async () => {
  ...
  it('[90008900] user using normal func to buy coin with wan ,should success ', async () => {
    ...
    it('[90008910] user convert cfnc to UM1S,should success ', async () => {
    ...
    it('[90009010] user1 transfer cfnc to user2,should success ', async () => {
